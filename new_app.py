...
# ══════════════════════════════════════════════
    ...
    with col1:
        ...
        # ← ADD THESE TWO LINES:
        marital_status      = st.selectbox("Marital Status", ["Partnered", "Single", "Widow"])
        education_group     = st.selectbox("Education Level", ["Postgraduate", "Undergraduate", "Other"])
    ...
    if st.button("🔍 Predict My Segment"):
        ...
        # ← ADD THIS: Dynamic one-hot encoding
        ...
        input_data = pd.DataFrame([[
            ...
            marital_partnered, marital_single, marital_widow,  # ← DYNAMIC!
            education_postgrad, education_undergrad  # ← DYNAMIC!
        ]], columns=[
